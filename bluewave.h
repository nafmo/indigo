...
//typedef SINT8          tCHAR;     /* 8 bit signed values           */
//typedef UINT8          tBYTE;     /* 8 bit unsigned values         */
//typedef SINT8          tINT[2];   /* little-endian 16 bit signed   */
//typedef UINT8          tWORD[2];  /* little-endian 16 bit unsigned */
//typedef SINT8          tLONG[4];  /* little-endian 32 bit signed   */
//typedef UINT8          tDWORD[4]; /* little-endian 32 bit unsigned */

//#else

typedef SINT8          tCHAR;     /* 8 bit signed values    */
typedef UINT8          tBYTE;     /* 8 bit unsigned values  */
typedef SINT16         tINT;      /* 16 bit signed values   */
typedef UINT16         tWORD;     /* 16 bit unsigned values */
typedef SINT32         tLONG;     /* 32 bit signed values   */
typedef UINT32         tDWORD;    /* 32 bit unsigned values */
